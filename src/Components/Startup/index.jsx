      ...
      <div className="startup_container">
        <div className="startup_container_left">
          <div className="startup_title_desc">
            <p className='startup_featured'>Xüsusi</p>
            <h2 className='startup_title'>Startup-ım üçün pul toplamağım lazımdır, ya yox?</h2>
          ...
          <div className="startup_button">
            <button className='statrup_btn'>İndi oxu<svg xmlns="http://www.w3.org/2000/svg" width="23" height="12" viewBox="0 0 23 12" fill="none">
