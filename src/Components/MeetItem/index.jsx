...
const MeetItem = ({image,name,job}) => {
  return (
    <div className='meet_item_list'>
    <div className='images_episodeitem'>
         <img src={image} alt="" />
    </div>
    <div className="meetitem_text_icon">
        <h3 className='meetItem_title'>{name}</h3>
        <p className='meetItem_desc'>{job}</p>
    </div>
    <div className="meet_bottom">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <g clip-path="url(#clip0_312_2692)">
